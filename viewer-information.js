let webinar = {
  ...
  countdownNode: function (req) {
    ...
    this.countdownContainers().forEach(function (clock) {
      clock.innerHTML = `<span class=${
        self.selector.countdownDays.split(".")[1]
      }></span>:<span class=${
        self.selector.countdownHours.split(".")[1]
      }>:</span>:<span
      class=${
        self.selector.countdownMinutes.split(".")[1]
      }></span>:<span class=${
        self.selector.countdownSeconds.split(".")[1]
      }></span>`;
      ...
      self.updateClock(endtime, daysSpan, hoursSpan, minutesSpan, secondsSpan);
      setInterval(
